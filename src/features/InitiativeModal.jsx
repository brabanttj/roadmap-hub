...
export default function InitiativeModal({
  ...
  // Chat is a separate append-only thread (post/delete only, no edit),
  // same "existing initiatives only" sub-resource pattern as Notes.
        ...
        <form className="im-form" onSubmit={handleSubmit}>
          ...
          {initiative && (
            <div className="im-chat">
              <span className="lt-field__label">Discussion</span>
              {chatError && (
                <div className="mt-banner" role="alert">
                  <span className="mt-banner__icon" aria-hidden="true">⚠️</span>
                  <span>{chatError}</span>
                  ...
                  <li key={c.id} className="im-chat__item">
                    ...
                    <div className="im-chat__meta">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        disabled={chatBusy}
                        onClick={() => deleteChatMessage(c.id)}
                      >
                        Delete
                      </Button>
                    </div>
